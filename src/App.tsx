...
function App() {
  ...
  return (
    <div className="min-h-screen bg-white dark:bg-gray-900 transition-colors duration-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-2xl font-bold text-gray-900 dark:text-white">EduAssist Pro</span>
            </div>
            <nav className="hidden md:flex space-x-8">
              ...
              <button onClick={() => scrollToSection('guarantees')} className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Guarantees</button>
              <button onClick={() => scrollToSection('faq')} className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">FAQ</button>
              <button onClick={() => scrollToSection('testimonials')} className="text-gray-700 dark:text-gray-300 hover:text-blue-600 dark:hover:text-blue-400 transition-colors">Reviews</button>
            ...
            <div className="flex items-center space-x-4">
              ...
              <span className="text-sm font-medium text-gray-900 dark:text-white">+1 (856) 647-3520</span>
            </div>
          </div>
        </div>
      </header>
      ...
      {/* Hero Section */}
      <section className="bg-gradient-to-br from-blue-50 via-indigo-50 to-purple-100 dark:from-gray-800 dark:via-gray-900 dark:to-gray-800 py-16 relative overflow-hidden">
        {/* Background Art */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid lg:grid-cols-2 gap-12 items-start">
            <div>
              <h1 className="text-5xl font-bold text-gray-900 dark:text-white mb-4 leading-tight mt-8">
      ...
      <section className="py-16 bg-white dark:bg-gray-900 relative">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <h2 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Trusted by Students Worldwide</h2>
          </div>
      ...
      <section id="services" className="py-20 bg-gray-50 dark:bg-gray-800 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-8">
            <div data-service="online-class" className="bg-white dark:bg-gray-700 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Online Class Help</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">Complete online course management including assignments, discussions, and quizzes.</p>
            ...
            <div data-service="exam" className="bg-white dark:bg-gray-700 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Exam Assistance</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">Expert help with midterms, finals, and standardized tests to ensure top performance.</p>
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <div data-service="tutoring" className="bg-white dark:bg-gray-700 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Tutoring Services</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">One-on-one tutoring sessions with subject matter experts.</p>
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <div data-service="assignment" className="bg-white dark:bg-gray-700 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Assignment Help</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">Professional assistance with essays, research papers, and projects.</p>
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="bg-white dark:bg-gray-700 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Urgent Help</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">Last-minute assistance for tight deadlines and emergency situations.</p>
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
            ...
            <div className="bg-white dark:bg-gray-700 rounded-xl p-8 shadow-lg hover:shadow-xl transition-shadow">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Proctored Exams</h3>
              <p className="text-gray-600 dark:text-gray-300 mb-4">Secure assistance with proctored examinations and assessments.</p>
              <ul className="space-y-2 text-sm text-gray-600 dark:text-gray-400">
      ...
      <section className="py-20 bg-white dark:bg-gray-900 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <h2 className="text-4xl font-bold text-gray-900 dark:text-white mb-4">Why Choose EduAssist Pro?</h2>
            <p className="text-xl text-gray-600 dark:text-gray-300 max-w-3xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">Expert Tutors</h3>
              <p className="text-gray-600 dark:text-gray-300">PhD-qualified professionals with years of teaching experience in their respective fields.</p>
            </div>
            <div className="text-center">
              ...
              <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-3">100% Confidential</h3>
              <p className="text-gray-600 dark:text-gray-300">Your privacy is our priority. All interactions and information are kept strictly confidential.</p>
            </div>
            <div className="text-center">
              ...
              <p className="text-gray-600 dark:text-gray-300">We guarantee timely completion of all assignments and projects before your deadline.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section id="testimonials" className="py-20 bg-gray-50 dark:bg-gray-800 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 dark:text-gray-300">Real feedback from satisfied students</p>
            <div className="flex items-center justify-center mt-6">
              <div className="h-1 w-24 bg-gradient-to-r from-yellow-500 to-orange-600 rounded-full"></div>
            </div>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-white dark:bg-gray-700 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">"EduAssist Pro helped me maintain my GPA while working full-time. Their tutors are incredibly knowledgeable and supportive."</p>
              <div className="flex items-center">
            ...
            <div className="bg-white dark:bg-gray-700 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">"The quality of work is exceptional. I went from failing to getting A's in my statistics course. Highly recommend!"</p>
              <div className="flex items-center">
                ...
                <div>
                  ...
                  <div className="text-sm text-gray-600 dark:text-gray-400">Psychology Major</div>
                </div>
              </div>
            </div>
            <div className="bg-white dark:bg-gray-700 rounded-xl p-8 shadow-lg hover:shadow-xl transition-all transform hover:-translate-y-1">
              ...
              <p className="text-gray-600 dark:text-gray-300 mb-6">"Professional, reliable, and always delivers on time. They saved my semester when I was overwhelmed with coursework."</p>
              <div className="flex items-center">
                ...
                <div>
                  <div className="font-semibold text-gray-900 dark:text-white">Amanda K.</div>
                  <div className="text-sm text-gray-600 dark:text-gray-400">Nursing Student</div>
                </div>
              </div>
            </div>
          </div>
      ...
      <section className="py-20 bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <h2 className="text-4xl font-bold text-white dark:text-gray-100 mb-4">Ready to Boost Your Grades?</h2>
      ...
      {/* Footer */}
      <footer className="bg-gradient-to-br from-gray-900 via-gray-800 to-gray-900 dark:from-gray-950 dark:via-gray-900 dark:to-gray-950 text-white py-16 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid md:grid-cols-4 gap-8">
            <div>
              <div className="flex items-center space-x-2 mb-4">
                ...
                <span className="text-2xl font-bold text-white">EduAssist Pro</span>
              </div>
            ...
            <div>
              ...
              <ul className="space-y-2 text-gray-400 dark:text-gray-500">
                <li><button onClick={() => {scrollToSection('services'); window.setTimeout(() => {const element = document.querySelector('[data-service="online-class"]'); element?.scrollIntoView({behavior: 'smooth', block: 'center'});}, 500);}} className="hover:text-white dark:hover:text-gray-200 transition-colors text-left">Online Class Help</button></li>
                <li><button onClick={() => {scrollToSection('services'); window.setTimeout(() => {const element = document.querySelector('[data-service="assignment"]'); element?.scrollIntoView({behavior: 'smooth', block: 'center'});}, 500);}} className="hover:text-white dark:hover:text-gray-200 transition-colors text-left">Assignment Writing</button></li>
                <li><button onClick={() => {scrollToSection('services'); window.setTimeout(() => {const element = document.querySelector('[data-service="exam"]'); element?.scrollIntoView({behavior: 'smooth', block: 'center'});}, 500);}} className="hover:text-white dark:hover:text-gray-200 transition-colors text-left">Exam Assistance</button></li>
                <li><button onClick={() => {scrollToSection('services'); window.setTimeout(() => {const element = document.querySelector('[data-service="tutoring"]'); element?.scrollIntoView({behavior: 'smooth', block: 'center'});}, 500);}} className="hover:text-white dark:hover:text-gray-200 transition-colors text-left">Tutoring</button></li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4 text-white">Support</h3>
              <ul className="space-y-2 text-gray-400 dark:text-gray-500">
                <li><button onClick={() => scrollToSection('faq')} className="hover:text-white dark:hover:text-gray-200 transition-colors">FAQ</button></li>
                <li><button onClick={() => window.open('https://wa.me/18566473520?text=Hi! I need help with my academic work. Can you provide more information about your services?', '_blank')} className="hover:text-white dark:hover:text-gray-200 transition-colors text-left">Live Chat</button></li>
                <li><button onClick={() => scrollToSection('contact')} className="hover:text-white dark:hover:text-gray-200 transition-colors">Contact Us</button></li>
                <li><button onClick={() => scrollToSection('guarantees')} className="hover:text-white dark:hover:text-gray-200 transition-colors">Guarantees</button></li>
              </ul>
            </div>
            <div>
              <h3 className="text-lg font-semibold mb-4 text-white">Contact Info</h3>
              <div className="space-y-2 text-gray-400 dark:text-gray-500">
                <button onClick={() => window.open('tel:+18566473520', '_blank')} className="flex items-center hover:text-white dark:hover:text-gray-200 transition-colors text-left">
                  <Phone className="h-4 w-4 mr-2" />
                  +1 (856) 647-3520
                </button>
                <button onClick={() => window.open('mailto:support@eduassistpro.com?subject=Inquiry about your services', '_blank')} className="flex items-center hover:text-white dark:hover:text-gray-200 transition-colors text-left">
                  <Mail className="h-4 w-4 mr-2" />
                  support@eduassistpro.com
                </button>
                <button onClick={() => window.open('https://wa.me/18566473520?text=Hi! I need help with my academic work. Can you assist me?', '_blank')} className="flex items-center hover:text-white dark:hover:text-gray-200 transition-colors text-left">
          ...
          <div className="border-t border-gray-700/50 dark:border-gray-800/50 mt-12 pt-8 text-center text-gray-400 dark:text-gray-500">
